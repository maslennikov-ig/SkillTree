...
export type QuestionType = 'MULTIPLE_CHOICE' | 'RATING' | 'BINARY' | 'OPEN_TEXT';
...
export interface Question {
  ...
  ratingRange?: { min: number; max: number; labels: { min: string; max: string } };
  isEasterEgg?: boolean;
  hint?: string;
}
...
const createScores = (primary: RIASECType, secondary?: RIASECType): RIASECScores => {
...
export const questions: Question[] = [
  ...
  
  {
    ...
    options: [
      ...
      { 
        text: "📚 Посмотрю научное видео или почитаю интересную статью", 
        value: "i1",
        scores: { R: 0, I: 1.0, A: 0.1, S: 0, E: 0, C: 0 }
      },
      { 
        text: "🎨 Порисую, попишу музыку или займусь творчеством", 
        value: "a1",
  ...
  {
    id: "q6",
    text: "📋 Как ты относишься к планированию и организации?",
    type: "RATING",
    section: 1,
    orderIndex: 6,
    difficulty: 1,
    ...
    ratingRange: {
      ...
      max: 5,
      labels: {
        min: "Терпеть не могу, живу хаосом 🌪️",
        max: "Обожаю! У меня всё по полочкам 📁"
      }
    }
  },
  ...
  {
    id: "q8",
    text: "🌿 Как насчёт работы на природе или с животными?",
    type: "RATING",
    section: 1,
    orderIndex: 8,
    difficulty: 1,
    ...
    ratingRange: {
      ...
      max: 5,
      labels: {
        min: "Не-не, я городской житель 🏙️",
        max: "Да! Природа — моя стихия 🌲"
      }
    }
  },
  
  {
    ...
    options: [
      ...
      { 
        text: "🤗 Помогать участникам и следить, чтобы всем было комфортно", 
        value: "s5",
  ...
  {
    id: "q14",
    text: "🎭 Уроки литературы, театра, МХК...",
    type: "RATING",
    section: 2,
    orderIndex: 14,
    difficulty: 2,
    ...
    ratingRange: {
      ...
      max: 5,
      labels: {
        min: "Скучно, не вижу смысла 💤",
        max: "Обожаю! Искусство — это жизнь 💫"
      }
    }
  },
  
  {
    ...
    options: [
      { 
        text: "👑 Лидер — распределяю задачи, слежу за дедлайнами", 
        value: "e7",
      ...
      { 
        text: "🔍 Исследователь — собираю информацию и анализирую", 
        value: "i7",
  ...
  {
    id: "q18",
    text: "📊 Экономика и обществознание...",
    type: "RATING",
    section: 2,
    orderIndex: 18,
    difficulty: 2,
    ...
    ratingRange: {
      ...
      labels: {
        min: "Зачем это нужно? 🤷",
        max: "Очень интересно, как устроен мир! 🌍"
      }
    }
  },
  ...
  {
    id: "q26",
    text: "👥 vs 🧍 Работа в команде или самостоятельно?",
    type: "RATING",
    section: 3,
    orderIndex: 26,
    difficulty: 2,
    ...
    ratingRange: {
      ...
      max: 5,
      labels: {
        min: "Только один/одна — так эффективнее 🧍",
        max: "Только в команде — вместе круче 👥"
      }
    }
  },
  ...
  
  {
    ...
    ratingRange: {
      ...
      max: 5,
      labels: {
        min: "Не люблю, предпочитаю сотрудничество 🤝",
        max: "Мотивирует! Люблю побеждать 🏆"
      }
    }
  },
  ...
  {
    id: "q29",
    text: "🎯 Что важнее: делать то, что любишь, или то, что хорошо оплачивается?",
    type: "RATING",
    section: 3,
    orderIndex: 29,
    difficulty: 3,
    ...
    ratingRange: {
      ...
      max: 5,
      labels: {
        min: "Деньги важнее, потом полюблю 💰",
        max: "Любовь к делу — главное ❤️"
      }
    }
  },
  ...
  {
    id: "q32",
    text: "💡 Ты скорее исполнитель или генератор идей?",
    type: "RATING",
    section: 3,
    orderIndex: 32,
    difficulty: 2,
    ...
    ratingRange: {
      ...
      max: 5,
      labels: {
        min: "Исполнитель — чётко делаю задачи 🛠️",
        max: "Генератор — фонтанирую идеями 💡"
      }
    }
  },
  ...
  {
    id: "q34",
    text: "🗣️ Как ты себя чувствуешь, выступая перед аудиторией?",
    type: "RATING",
    section: 4,
    orderIndex: 34,
    difficulty: 2,
    ...
    ratingRange: {
      ...
      max: 5,
      labels: {
        min: "Ужас, стараюсь избегать 😰",
        max: "Кайф, люблю внимание! 🎤"
      }
    }
  },
  ...
  {
    id: "q35",
    text: "📊 Работа с цифрами и таблицами...",
    type: "RATING",
    section: 4,
    orderIndex: 35,
    difficulty: 2,
    ...
    ratingRange: {
      ...
      max: 5,
      labels: {
        min: "Не моё, голова кругом 🤯",
        max: "Люблю! Цифры — это порядок 📈"
      }
    }
  },
  ...
  {
    id: "q37",
    text: "🎭 Легко ли тебе понимать чувства других людей?",
    type: "RATING",
    section: 4,
    orderIndex: 37,
    difficulty: 2,
    ...
    ratingRange: {
      ...
      max: 5,
      labels: {
        min: "Сложно, не всегда понимаю 🤔",
        max: "Легко, сразу чувствую настроение 💫"
      }
    }
  },
  ...
  {
    id: "q38",
    text: "🔨 Нравится ли тебе работать руками — мастерить, чинить, строить?",
    type: "RATING",
    section: 4,
    orderIndex: 38,
    difficulty: 2,
    ...
    ratingRange: {
      ...
      labels: {
        min: "Совсем не моё 🙅",
        max: "Обожаю! Руки чешутся что-то создать 🛠️"
      }
    }
  },
  ...
  {
    id: "q43",
    text: "⚡ Быстрые решения или тщательный анализ?",
    type: "RATING",
    section: 4,
    orderIndex: 43,
    difficulty: 2,
    ...
    ratingRange: {
      ...
      max: 5,
      labels: {
        min: "Быстро решаю, потом разберусь ⚡",
        max: "Тщательно анализирую, потом действую 🔍"
      }
    }
  },
  ...
  {
    id: "q44",
    text: "🌈 Насколько важно для тебя выражать свою индивидуальность?",
    type: "RATING",
    section: 4,
    orderIndex: 44,
    difficulty: 2,
    ...
    ratingRange: {
      ...
      max: 5,
      labels: {
        min: "Не особо, вписываюсь в нормы 📋",
        max: "Очень! Я уникален/а и горжусь этим 🦋"
      }
    }
  },
  ...
  {
    id: "q45",
    text: "🔧 Собирать мебель по инструкции — это...",
    type: "BINARY",
    section: 5,
    orderIndex: 45,
    difficulty: 1,
  ...
  {
    id: "q46",
    text: "🔬 Читать научные статьи в свободное время?",
    type: "BINARY",
    section: 5,
    orderIndex: 46,
    difficulty: 1,
    ...
    options: [
      ...
      { 
        text: "🎬 Не особо, предпочитаю другой контент", 
        value: "no",
  ...
  {
    id: "q47",
    text: "🎨 Рисовать, лепить или создавать что-то руками?",
    type: "BINARY",
    section: 5,
    orderIndex: 47,
    difficulty: 1,
  ...
  {
    id: "q49",
    text: "💼 Вести переговоры и убеждать людей?",
    type: "BINARY",
    section: 5,
    orderIndex: 49,
    difficulty: 1,
  ...
  {
    id: "q50",
    text: "📁 Сортировать файлы и наводить порядок в документах?",
    type: "BINARY",
    section: 5,
    orderIndex: 50,
    difficulty: 1,
  ...
  {
    id: "q51",
    text: "🌿 Ухаживать за растениями или животными?",
    type: "BINARY",
    section: 5,
    orderIndex: 51,
    difficulty: 1,
  ...
  {
    id: "q54",
    text: "🎯 Быстро: ты скорее реалист или мечтатель?",
    type: "BINARY",
    section: 5,
    orderIndex: 54,
    difficulty: 1,
...
export const careers: Career[] = [
  ...
  
  {
    ...
    category: "technology",
    requiredSkills: ["Python", "SQL", "Статистика", "ML/DL", "Pandas", "Sklearn"],
    educationPath: ["Математика ЕГЭ 90+", "Программирование", "Магистратура ML"],
  ...
  
  {
    ...
    category: "technology",
    requiredSkills: ["Linux", "Docker/K8s", "CI/CD", "Terraform", "Python/Bash"],
  ...
  
  {
    ...
    description: "Управление продуктом, стратегия, работа с командой и метриками",
    ...
    category: "technology",
    requiredSkills: ["Product metrics", "Agile/Scrum", "UX", "Аналитика", "Коммуникация"],
  ...
  
  {
    ...
    salarySource: "Habr Career 2024: медиана ~200K ₽",
    category: "technology",
    requiredSkills: ["UML", "SQL", "BPMN", "Техническое письмо", "Коммуникация"],
  ...
  
  {
    ...
    universities: ["МФТИ", "МГТУ им. Баумана", "МИРЭА", "Positive Technologies"],
    outlook: "growing",
    demandLevel: "high"
  },
  ...
  
  {
    ...
    category: "technology",
    requiredSkills: ["Python", "PyTorch/TensorFlow", "MLOps", "Математика", "NLP/CV"],
  ...
  
  {
    ...
    category: "creative",
    requiredSkills: ["Adobe CC", "Figma", "Типографика", "Композиция", "Брендинг"],
  ...
  
  {
    ...
    category: "creative",
    requiredSkills: ["AutoCAD", "Revit", "3ds Max", "Архитектурное проектирование"],
  ...
  
  {
    ...
    category: "creative",
    requiredSkills: ["Музыкальный инструмент", "DAW", "Теория музыки", "Саунд-дизайн"],
  ...
  
  {
    ...
    category: "business",
    requiredSkills: ["Рекрутинг", "HR-аналитика", "Трудовое право", "Коммуникация"],
  ...
  
  {
    ...
    category: "business",
    requiredSkills: ["Excel", "SQL", "Финмоделирование", "Power BI", "Accounting"],
  ...
  
  {
    ...
    universities: ["Skolkovo", "ВШЭ", "МФТИ стартапы", "Y Combinator Startup School"],
    outlook: "growing",
    demandLevel: "medium"
  },
  ...
  
  {
    ...
    category: "science",
    requiredSkills: ["Методология", "Статистика", "Научное письмо", "Эксперименты"],
  ...
  
  {
    ...
    category: "science",
    requiredSkills: ["Биология", "Лабораторные методы", "Статистика", "Биоинформатика"],
  ...
  
  {
    ...
    category: "social",
    requiredSkills: ["Педагогика", "Предметные знания", "Коммуникация", "Терпение"],
  ...
  
  {
    ...
    category: "social",
    requiredSkills: ["Иностранные языки", "Специализированная лексика", "Точность"],
...
export const careerStats = {
  ...
  salaryRange: {
    ...
    avgMin: Math.round(careers.reduce((sum, c) => sum + c.salaryMin, 0) / careers.length),
    avgMax: Math.round(careers.reduce((sum, c) => sum + c.salaryMax, 0) / careers.length),
  }
};
